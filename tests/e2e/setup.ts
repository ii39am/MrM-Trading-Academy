...
export default async function setup(){
 ...
 const passwordHash=await bcrypt.hash("SecurePass123",12),course=await db.course.upsert({where:{id:"e2e-product-mrme"},update:{status:"PUBLISHED",publishedAt:new Date(),telegramChatId:"-1001234567890",telegramAccessEnabled:true},create:{id:"e2e-product-mrme",slug:"e2e-private-access",titleEn:"E2E Private Access",titleAr:"وصول اختباري خاص",shortDescriptionEn:"Private trading product access",shortDescriptionAr:"وصول خاص لمنتج التداول",fullDescriptionEn:"A complete private trading education product.",fullDescriptionAr:"منتج تعليمي متكامل وخاص للتداول.",instructor:"Mr.ME",priceCents:34900,currency:"USD",image:"https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3",accent:"#3B82F6",telegramChatId:"-1001234567890",telegramAccessEnabled:true,status:"PUBLISHED",publishedAt:new Date()}});
