...
const user=(role:User["role"],status:User["status"]="ACTIVE"):User=>({id:"u",name:"User",email:"user@example.test",emailVerified:true,role,status,sessionVersion:1,preferredLanguage:"en"});
