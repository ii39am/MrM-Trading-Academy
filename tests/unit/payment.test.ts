...
describe("payment state machine",()=>{
 ...
 it("allows a delayed full confirmation after expiry or cancellation",()=>{expect(canTransition("EXPIRED","PAID")).toBe(true);expect(canTransition("CANCELLED","PAID")).toBe(true)});
