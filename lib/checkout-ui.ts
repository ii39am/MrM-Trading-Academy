...
const en = {
  ...
  receivedPending: "Payment detected. Do not send the full amount again. Wait for an update or contact support before sending more.",
  network: "Network",
  ...
  errors: {
    ...
    PAYMENT_AMOUNT_BELOW_PROVIDER_MINIMUM: "The order amount is below the current minimum supported by the payment provider.",
...
const ar: typeof en = {
  ...
  receivedPending: "تم رصد دفعة. لا ترسل المبلغ الكامل مرة أخرى. انتظر تحديث الحالة أو تواصل مع الدعم قبل إرسال أي مبلغ إضافي.",
  network: "الشبكة",
  ...
  errors: {
    ...
    PAYMENT_AMOUNT_BELOW_PROVIDER_MINIMUM: "قيمة الطلب أقل من الحد الأدنى الحالي الذي يدعمه مزود الدفع.",
